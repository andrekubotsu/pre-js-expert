...
export default function setAPI() {
    ...
    assert.deepStrictEqual(uniqueFromDb2.size, (MAX_ITEMS / EVEN_MULTIPLE)) // vai ser só os impares, pq o db1 vai ser removido os duplicados

    const allDatabaseWithoutReplications = new Set([...carsDb1, ...carsDb2]) // não adiciona dados replicados
